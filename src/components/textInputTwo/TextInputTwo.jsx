    ...
    return (
        <div className='alpha-input_two_container' style={props.style} >
            ...
            <div className='alpha-input_two_container_input' style={props.inputStyle}>
                <input maxLength={props?.maxLength} disabled={props.disabled} style={props.inputStyle} onKeyPress={props.onKeyPress} onChange={props.onChange} value={props.value} type={props.type} placeholder={props.placeholder} />
                {props.type === 'dropdown' &&
