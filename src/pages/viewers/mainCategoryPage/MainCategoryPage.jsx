...
import { close, drawerIcon, menu, search, searchWhite } from "../../../assets/icons";
          ...
          <div className="alpha-main_cat_page_item_top_view" >
            ...
            <div className="alpha-main_cat_page_items_top_view">
              {categoriesArray.map((item, index) => {
                return (
                  <DashboardCategoriesView onClick={() => navigate('/productlistingpage')} titleStyle={{ fontSize: 18 }} containerStyle={{ width: 264, height: 256, marginRight: 30, marginBottom: 30 }} item={item} index={index} />
                )
              })}
            </div>
